...
typedef enum {
  GUI_DEBUG_LOGLEVEL_INFO,
  GUI_DEBUG_LOGLEVEL_WARNING,
  GUI_DEBUG_LOGLEVEL_ERROR,
  //
  GUI_DEBUG_LOGLEVEL_NUMLEVELS,
} GUI_DEBUG_LOGLEVEL;

void         GUI__LogInternal(GUI_DEBUG_LOGLEVEL Level, const char * sFilePath, int Line, const char * sFmt, ...);
const char * GUI__GetBaseName(const char * sFilePath);

//
// Helper macros.
//
#define MAKE_FMT_STRING(FMT_STR)           FMT_STR "\n"
#define MAKE_FMT_STRING_IF(FMT_STR, EXP)   #EXP "\n" FMT_STR "\n"

#define _DEBUG_LOG_IMPL_NOARGS(LEVEL, FILE, LINE, FMT_STR)                     GUI__LogInternal(LEVEL, FILE, LINE, MAKE_FMT_STRING(FMT_STR))
#define _DEBUG_LOG_IMPL_VARGS(LEVEL, FILE, LINE, FMT_STR, ...)                 GUI__LogInternal(LEVEL, FILE, LINE, MAKE_FMT_STRING(FMT_STR), __VA_ARGS__)
#define _DEBUG_LOG_IF_IMPL_NOARGS(LEVEL, FILE, LINE, EXPRESSION, FMT_STR, ...) if (EXPRESSION) { GUI__LogInternal(LEVEL, FILE, LINE, MAKE_FMT_STRING_IF(FMT_STR, EXPRESSION)); }
#define _DEBUG_LOG_IF_IMPL_VARGS(LEVEL, FILE, LINE, EXPRESSION, FMT_STR, ...)  if (EXPRESSION) { GUI__LogInternal(LEVEL, FILE, LINE, MAKE_FMT_STRING_IF(FMT_STR, EXPRESSION), __VA_ARGS__); }

//
// Main logging macros.
//
#if GUI_DEBUG_LEVEL >= GUI_DEBUG_LEVEL_LOG_ALL
  #define GUI_DEBUG_INFO(FMT)                        _DEBUG_LOG_IMPL_NOARGS(GUI_DEBUG_LOGLEVEL_INFO,    __FILE__, __LINE__, FMT)
  #define GUI_DEBUG_INFO_VA(FMT, ...)                _DEBUG_LOG_IMPL_VARGS(GUI_DEBUG_LOGLEVEL_INFO,     __FILE__, __LINE__, FMT, __VA_ARGS__)
  #define GUI_DEBUG_INFO_IF(EXPRESSION, FMT)         _DEBUG_LOG_IF_IMPL_NOARGS(GUI_DEBUG_LOGLEVEL_INFO, __FILE__, __LINE__, EXPRESSION, FMT)
  #define GUI_DEBUG_INFO_VA_IF(EXPRESSION, FMT, ...) _DEBUG_LOG_IF_IMPL_VARGS(GUI_DEBUG_LOGLEVEL_INFO,  __FILE__, __LINE__, EXPRESSION, FMT, __VA_ARGS__)
#else
  #define GUI_DEBUG_INFO(FMT)                        
  #define GUI_DEBUG_INFO_VA(FMT, ...)                
  #define GUI_DEBUG_INFO_IF(EXPRESSION, FMT)         
  #define GUI_DEBUG_INFO_VA_IF(EXPRESSION, FMT, ...) 
#endif

#if GUI_DEBUG_LEVEL >= GUI_DEBUG_LEVEL_LOG_WARNINGS
  #define GUI_DEBUG_WARNING(FMT)                        _DEBUG_LOG_IMPL_NOARGS(GUI_DEBUG_LOGLEVEL_WARNING,    __FILE__, __LINE__, FMT)
  #define GUI_DEBUG_WARNING_VA(FMT, ...)                _DEBUG_LOG_IMPL_VARGS(GUI_DEBUG_LOGLEVEL_WARNING,     __FILE__, __LINE__, FMT, __VA_ARGS__)
  #define GUI_DEBUG_WARNING_IF(EXPRESSION, FMT)         _DEBUG_LOG_IF_IMPL_NOARGS(GUI_DEBUG_LOGLEVEL_WARNING, __FILE__, __LINE__, EXPRESSION, FMT)
  #define GUI_DEBUG_WARNING_VA_IF(EXPRESSION, FMT, ...) _DEBUG_LOG_IF_IMPL_VARGS(GUI_DEBUG_LOGLEVEL_WARNING,  __FILE__, __LINE__, EXPRESSION, FMT, __VA_ARGS__)
#else
  #define GUI_DEBUG_WARNING(FMT)                        
  #define GUI_DEBUG_WARNING_VA(FMT, ...)                
  #define GUI_DEBUG_WARNING_IF(EXPRESSION, FMT)         
  #define GUI_DEBUG_WARNING_VA_IF(EXPRESSION, FMT, ...) 
#endif

#if GUI_DEBUG_LEVEL >= GUI_DEBUG_LEVEL_LOG_ERRORS
  #define GUI_DEBUG_ERROR(FMT)                        _DEBUG_LOG_IMPL_NOARGS(GUI_DEBUG_LOGLEVEL_ERROR,    __FILE__, __LINE__, FMT)
  #define GUI_DEBUG_ERROR_VA(FMT, ...)                _DEBUG_LOG_IMPL_VARGS(GUI_DEBUG_LOGLEVEL_ERROR,     __FILE__, __LINE__, FMT, __VA_ARGS__)
  #define GUI_DEBUG_ERROR_IF(EXPRESSION, FMT)         _DEBUG_LOG_IF_IMPL_NOARGS(GUI_DEBUG_LOGLEVEL_ERROR, __FILE__, __LINE__, EXPRESSION, FMT)
  #define GUI_DEBUG_ERROR_VA_IF(EXPRESSION, FMT, ...) _DEBUG_LOG_IF_IMPL_VARGS(GUI_DEBUG_LOGLEVEL_ERROR,  __FILE__, __LINE__, EXPRESSION, FMT, __VA_ARGS__)
#else
  #define GUI_DEBUG_ERROR(FMT)                        
  #define GUI_DEBUG_ERROR_VA(FMT, ...)                
  #define GUI_DEBUG_ERROR_IF(EXPRESSION, FMT)         
  #define GUI_DEBUG_ERROR_VA_IF(EXPRESSION, FMT, ...) 
#endif

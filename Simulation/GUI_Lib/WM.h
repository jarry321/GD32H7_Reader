...
#define WM_CREATE_WIDGET            0x0039  /* Send from a few widgets after finishing the complete process of creation */
...
#define WM_CF_STATIC           (1UL << 16) // A static memory device is used for drawing. That means if a window with this flag receives a
                                           ...
                                           // This kind of drawing a window can improve the performance a lot, but needs a large amount of RAM.
...
/* Automatic use of partial frame buffer */
void WM_BANDING_Enable(int OnOff);

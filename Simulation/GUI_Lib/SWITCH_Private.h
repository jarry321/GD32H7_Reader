...
int  SWITCH__GetState           (SWITCH_Obj * pObj);
int  SWITCH__ToggleOrSetPosition(SWITCH_Handle hObj, SWITCH_Obj * pObj, int Dir);

extern void (* SWITCH__pDefaultCallback)(WM_MESSAGE * pMsg);

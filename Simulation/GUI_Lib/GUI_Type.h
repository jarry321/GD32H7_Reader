...
*
*  Description
*    An abstract type for generic function pointers.
*/
...
*       Return values
*/
typedef U8           GUI_BOOLEAN;
#define GUI_TRUE   ((GUI_BOOLEAN)1)
#define GUI_FALSE  ((GUI_BOOLEAN)0)
...
#define GUI_FONTINFO_FLAG_AA8     (1 << 6)    // Font is an antialiased font with 8bpp anti-aliasing.
...
/* PROP_AA8_EXT: Proportional, antialiased fonts, 8bpp, extended font information */
#define GUI_FONTTYPE_PROP_AA8_EXT   \
  GUIPROP_AA8_EXT_DispChar,         \
  GUIPROP_EXT_GetCharDistX,         \
  GUIPROP_AA8_EXT_GetFontInfo,      \
  GUIPROP_EXT_IsInFont,             \
  GUIPROP_EXT_GetCharInfo,          \
  &GUI_ENC_APIList_EXT
...
#define GUI_SIF_TYPE_PROP_AA8_EXT &GUI_SIF_APIList_Prop_AA8_EXT
...
#define GUI_SIF_TYPE_PROP_STD_AA8   GUI_SIF_TYPE_PROP_AA8_EXT    // Should be used if the parameter \a{pFont} points to a standard proportional font that uses 8bpp anti-aliasing.
...
#define GUI_XBF_TYPE_PROP_AA8_EXT &GUI_XBF_APIList_Prop_AA8_Ext
...
#define GUI_XBF_TYPE_PROP_STD_AA8     GUI_XBF_TYPE_PROP_AA8_EXT    // Should be used if the parameter \a{pFont} points to a standard proportional font that uses 8bpp anti-aliasing.
...
typedef struct {
  ...
  U32 Flags;             /* Emphasis flags, used for embolding and obliqueing the font.  */
} GUI_TTF_CS;

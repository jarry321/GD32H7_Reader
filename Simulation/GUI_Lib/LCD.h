...
/*********************************************************************
*
*       Macros to be used for banding
*
**********************************************************************
*/
#define GUI_BANDING_ENABLE 0x01
#define GUI_BANDING_START  0x02
#define GUI_BANDING_NEXT   0x03
#define GUI_BANDING_STOP   0x04
...
#define LCD_DEVCAP_BANDING           0x15    // Get number of bands when using partial frame buffer
...
#define LCD_DEVFUNC_BANDING        0x29 /* ...getting a function for banding */
...
#define LCD_X_WAIT4EOF       0x10 /* Wait for end of frame */
#define LCD_X_COPYBUFFER     0x11 /* Copy partial frame buffer via DMA to front buffer */
...
int LCD_HasCache      (void);
int LCD_HasCacheEx    (int LayerIndex);
